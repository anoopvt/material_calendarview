...
import com.anoopvt.material_calendarview.exceptions.InvalidCustomLayoutException
...
class CalendarDayAdapter(
    ...
    private fun TextView.loadIcon(day: Calendar) {
        ...
        calendarProperties.eventDays.firstOrNull { it.calendar == day }?.let { eventDay ->
            ...
            loadImage(eventDay.imageDrawable,eventDay.labelColor)
