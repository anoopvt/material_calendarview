...
import com.anoopvt.material_calendarview.getDatesRange
import java.util.*
...
class DayRowClickListener(
    ...
    private fun reverseUnselectedCelColor(selectedDay: SelectedDay) {
        setCurrentMonthDayCelColors(
            selectedDay.calendar,
            selectedDay.view as? LinearLayout,
            calendarProperties
        )
    }
